...
function dTree(objName, objbool) {        // void 构造方法，创建树对象。objName: 树名称。objbool：单选多选 true多选  false单选  默认单选         
    ...
    this.icon = {
        root:        '/images/base.gif',         // Node 根节点。
        folder:      '/images/folder.gif',       // Node 根节点。
        folderOpen:  '/images/folderopen.gif',   // 打开的文件夹,默认'img/folderOpen.gif'
        node:        '/images/page.gif',         // 打开的文件夹,默认'img/folderOpen.gif'
        empty:       '/images/empty.gif',        // 打开的文件夹,默认'img/folderOpen.gif'
        line:        '/images/line.gif',         // 竖线,默认'img/line.gif'
        join:        '/images/join.gif',         // 丁线,默认'img/join.gif'
        joinBottom:  '/images/joinbottom.gif',   // 直角线,默认'img/joinbottom.gif'
        plus:        '/images/plus.gif',         // 加号丁线,默认'img/plus.gif'
        plusBottom:  '/images/plusbottom.gif',   // 加号直角线,默认'img/plusbottom.gif'
        minus:       '/images/minus.gif',        // 减号丁线,默认'img/minus.gif'
        minusBottom: '/images/minusbottom.gif',  // 减号直角线,默认'img/minusbottom.gif'
        nlPlus:      '/images/nolines_plus.gif', // 减号直角线,默认'img/minusbottom.gif'
        nlMinus:     '/images/nolines_minus.gif' //无线减号,默认'img/nolines_minus.gif'
    };
